...
export function findMinMax<T extends object, K extends keyof T>(array: T[], key: K): [T[K], T[K]] | [undefined, undefined];
export function findMinMax<T, K extends keyof T>(
    array: T[],
    key?: K,
): K extends undefined ? [T, T] | [undefined, undefined] : [T[K], T[K]] | [undefined, undefined] {
    if (!array?.length) {
        return [undefined, undefined] as K extends undefined ? [T, T] | [undefined, undefined] : [T[K], T[K]] | [undefined, undefined];
    }
